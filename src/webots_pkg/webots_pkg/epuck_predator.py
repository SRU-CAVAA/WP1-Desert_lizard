...
class MyEpuckPredator:
    def init(self, webots_node, properties):
        ...
        self.__node = rclpy.create_node('epuck_predator')

        self.__node.get_logger().info('------------- ----------------- epuck_predator -------------- -------------')
        ...
        self.__node.create_subscription(Range, 'epuck_predator/ps0', self.__ps0_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps1', self.__ps1_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps2', self.__ps2_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps3', self.__ps3_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps4', self.__ps4_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps5', self.__ps5_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps6', self.__ps6_sensor_callback, 1)
        self.__node.create_subscription(Range, 'epuck_predator/ps7', self.__ps7_sensor_callback, 1)
    ...
    def random_action(self, action_interval):
        ...
        if self.action_interval_counter > action_interval:
            ...
            if self.obstacle == True:
                ...
                if self.wheel_speed_r < 1.0: self.wheel_speed_r = 1.0
                if self.wheel_speed_r > 4.0: self.wheel_speed_r = 4.0
                if self.wheel_speed_l < 1.0: self.wheel_speed_l = 1.0
                if self.wheel_speed_l > 4.0: self.wheel_speed_l = 4.0
